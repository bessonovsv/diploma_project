...
MAGNIT_URL = "https://market-delivery.yandex.ru/retail/magnit_celevaya?placeSlug=magnit_dv7qk"
PURCHASE_1_URL = "https://market-delivery.yandex.ru/retail/magnit_celevaya?item=fb488f3a-7943-4fe8-8e40-9a4946d82cf2&placeSlug=magnit_dv7qk"
PURCHASE_URL = "https://market-delivery.yandex.ru/retail/magnit_celevaya?placeSlug=magnit_celevaya_bdvsq"

# Дополнительные настройки URL для тестов
ENDPOINT_1 = "v2/menu/product?auto_translate=false"
ENDPOINT_2 = "v1/cart?longitude=31.22887&latitude=58.50861&screen=menu&shippingType=delivery&autoTranslate=false"
ENDPOINT_3 = "v2/cart?longitude=31.22887&latitude=58.50861&screen=checkout&shippingType=delivery&autoTranslate=false"
...
COOKIES = {
    "_yasc": "+AEhlHp8v/Sql1fGrrzRldq6n1anUithbS769arBjKH0hDG0nxxawuh4XvRPfceFbg==",
    "i": "DaqnckxTub6fN4/LhO8ZPZhGv9uauEwI4LcBwLZzVSynRrysRAPz58lpE8fjaKLHAj3S+BZGMTmJen0TZxi0cYvSNRI=",
...
SELECTORS = {
    ...
    "shop_link": '#main > div > div > main > div:nth-child(3) > div > div > div > div > ul > li:nth-child(1) > div > a > div > div.ckb1wui',
    ...
    "carrot_button_in_Korean": 'button.f1d17p5r[aria-label="Морковь по-корейски 200 г, 75, 200г"]',
    "product_name_1": 'h1.cllwzwr',
    "response_text": '.ptdetd8.UiKitText_root.UiKitText_Title2Loose.UiKitText_Bold.UiKitText_Text',
